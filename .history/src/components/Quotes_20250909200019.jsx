...
export default function Quotes() {
    ...
    // friendship
        ...
        { quote: { en: "You cannot swim for new horizons until you have courage to lose sight of the shore.", it: "Non puoi nuotare verso nuovi orizzonti finché non hai il coraggio di perdere di vista la riva." }, type
        // choices and Regret
