...
export default function BannerHead({
  ...
  return (
    <div className="banner-container" onClick={() => navigate("/")}>
      ...
      <div className="quote-toggle" onClick={() => setShowQuotes(!showQuotes)}>
        {showQuotes ? (language === "en" ? "Hide Quotes" : "Nascondi Citazioni") : (language === "en" ? "Show Quotes" : "Mostra Citazioni")}
      </div>
      {showQuotes && (
