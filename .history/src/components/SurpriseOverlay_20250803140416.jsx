...
export default function SurpriseOverlay({
 ...
 const [isPortrait, setIsPortrait] = useState(false);
  ...
  useEffect(() => {
    ...
    setInterval() =>{handleEnvironment()}, 500) // run every 500ms

    window.addEventListener("resize", handleEnvironment);
    return () => window.removeEventListener("resize", handleEnvironment);
  }, []);
  ...
  return (
    <div className="overlay-modal-suprise">
      ...
      >
        <source src={!isMobile && !isTouch && !isPortrait ? BgVid : BgVid2} type="video/mp4" />
