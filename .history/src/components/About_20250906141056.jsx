...
export default function AboutComponent() {
  ...
  const aboutLyrics = AboutRosesLyrics();
  ...
  // assign audioRef on mount
  useEffect(() => { 
    audioRef.current = new Audio(AboutHymn);
    audioRef.current.preload = "auto";
    audioRef.current.crossOrigin = "anonymous"; // Handle CORS if needed
  }, [audioRef]);
   ...
   useEffect(() => {
    ...
    }, [showSurprise, audioRef]); // Only re-run when showSurprise changes
