...
export function RosesOfRomeVideos () {
  ...
  description: {
    en: "A vibrant gathering of Kenyan artistry. This sonnet stands as the studio's salute to the voices, colors, and visions emerging from the heart of Africa — where every artist meets another like a verse in a living poem.",
    it: "Un incontro vibrante dell’arte kenyana. Questo sonetto è il saluto dello studio alle voci, ai colori e alle visioni che emergono dal cuore dell’Africa — dove ogni artista incontra un altro come un verso in una poesia vivente.",
  },
  thumbnail: null,
  author: "Roses Of Rome",
  datePublished: null,
