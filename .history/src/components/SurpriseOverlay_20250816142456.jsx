...
>
  ...
  <div 
    ...
    style={{
      ...
      background: `
        linear-gradient(#111, transparent) content-box,
        conic-gradient(
          ${audioState === "stalled" ? "#ff4d4d" : "#00ffff"} 0deg, 
          ${audioState === "stalled" ? "#ff4d4d" : "#00ffff"} ${(audioRef.current?.currentTime / audioRef.current?.duration || 0) * 360}deg, 
          transparent ${(audioRef.current?.currentTime / audioRef.current?.duration || 0) * 360}deg
        ) border-box`
    }}
  ></div>
