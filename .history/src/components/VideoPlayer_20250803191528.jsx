...
export default function VideoPlayer({ videoFile, type = "video/mp4", autoPlay = false, permission }) {
 ...
 const togglePlayPause = () => {
  ...
  return (
    ...
    >
        {!permission ? (
      <div style={{ padding: "2rem", textAlign: "center", backgroundColor: "#111", color: "#fff", borderRadius: "8px", width: "100%", height: "100%" , display: "flex", alignItems: "center", justifyContent: }}>
