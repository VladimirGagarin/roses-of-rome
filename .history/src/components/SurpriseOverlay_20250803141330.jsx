...
export default function SurpriseOverlay({
  ...
  useEffect(() => {
    ...
    const interval = setInterval(handleEnvironment, 1000);
  ...
  console.log(JSON.stringify(env)); // → {"isMobile":true,"isTouch":false,"isPortrait":true}
  ...
  return (
    <div className="overlay-modal-suprise">
      ...
      >
        <source
          src={
            !env.isMobile && !env.isTouch && !env.isPortrait ? BgVid2 : BgVid2
          }
          type="video/mp4"
        />
