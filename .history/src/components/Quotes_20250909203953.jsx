...
export default function Quotes() {
    ...
    const RosesOfRomeQuotes = [
        ...
        { quote: { en: "Love is when the other person's happiness is more important than your own.", it: "L'amore è quando la felicità dell'altra persona è più importante della tua." }, type: { en: "Love", it: "Amore" } },
        // hope
        ...
        { quote: { en: "Every artist dips his brush in his own soul, and paints his own nature into his pictures.", it: "Ogni artista intinge il suo pennello nella propria anima e dipinge la propria natura nei suoi quadri." }, type: { en: "Art", it: "Arte" } },
        { quote: { en: "Art is the most beautiful of all lies.", it: "L'arte è la più bella di tutte le bugie." }, type: { en: "Art", it: "Arte" } },
        { quote: { en: "Art is the most beautiful of all lies.", it: "L'arte è la più bella di tutte le bugie." }, type: { en: "Art", it: "Arte" } },
        // nature
        { quote: { en: "Look deep into nature, and then you will understand everything better.", it: "Guarda a fondo nella natura, e poi capirai tutto meglio." }, type: { en: "Nature", it: "Natura" } },
        { quote: { en: "In every walk with nature one receives far more than he seeks.", it: "In ogni passeggiata nella natura si riceve molto più di quanto si cerca." }, type: { en: "Nature", it: "Natura" } },
        { quote: { en: "The earth has music for those who listen.", it: "La terra ha musica per coloro che ascoltano." }, type: { en: "Nature", it: "Natura" } },
        { quote: { en: "Adopt the pace of nature: her secret is patience.", it: "Adotta il ritmo della natura: il suo segreto è la pazienza." }, type: { en: "Nature", it: "Natura" } },
        // dreams
        ...
        // heart
        { quote: { en: "Wherever you go, go with all your heart.", it: "Ovunque tu vada, vai con tutto il tuo cuore." }, type: { en: "Heart", it: "Cuore" } },
        { quote: { en: "The best and most beautiful things in the world cannot be seen or even touched - they must be felt with the heart.", it: "Le cose migliori e più belle del mondo non possono essere viste o nemmeno toccate - devono essere sentite con il cuore." }, type: { en: "Heart", it: "Cuore" } },
        { quote: { en: "Follow your heart, but take your brain with you.", it: "Segui il tuo cuore, ma porta con te il cervello." }, type: { en: "Heart", it: "Cuore" } },
        { quote: { en: "A loving heart is the truest wisdom.", it: "Un cuore amorevole è la saggezza più vera." }, type: { en: "Heart", it: "Cuore" } },
        { quote: { en: "The heart has its reasons which reason knows not of.", it: "Il cuore ha le sue ragioni che la ragione non conosce." }, type: { en: "Heart", it: "Cuore" } },
    ];
