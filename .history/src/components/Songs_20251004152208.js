...
import PrayerSongVersion3 from "../assets/audios/prayer3.mp3";
...
import KenyaSong1 from "../assets/audios/kenya_official";
import  KenyaSong2 from "../assets/audios/kenya_duet.m"
...
export function RosesOfRomeSongs() {
  const songs = [
    ...
    },
    {
      ...
      songName: {
        en: "The Prayer (Version 2)",
        it: "La Preghiera (Versione 2)",
      },
      songLyrics: [],
      songAlbum: "Rosa",
    },
    {
      songId: SONG_UUIDS.rorMusic_052,
      songFile: PrayerSongVersion3,
      songName: {
        en: "The Prayer (Version 3)",
        it: "La Preghiera (Versione 3)",
      },
      songLyrics: [],
      songAlbum: "Rosa",
    },
    {
      songId: SONG_UUIDS.rorMusic_053,
      songFile: YellowSong,
      songName: {
        en: "I love Yellow",
        it: "Amore yellow"
    ...
    {
      songId: SONG_UUIDS.rorMusic_056,
      songFile: SerendipitySong,
      songName: {
        en: "Serendipty",
        it: "Serendipty",
      },
