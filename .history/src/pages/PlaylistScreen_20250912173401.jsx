      ...
      {selectedAlbum && (
        <div className="album-description">
          ...
          <button
            ...
            title={language === "it" ? "Condividi link album" : "Share this album link"}
            aria-label={language === "it" ? "Condividi link album" : "Share this album link"}
          >
            {language === "it" ? "Condividi  album" : "Share this album"}
          </button>
        </div>
      )}
