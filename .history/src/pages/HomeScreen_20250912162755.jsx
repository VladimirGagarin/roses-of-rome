    ...
    <div className="home-container">
      ...
      <div className="audio-wrapper">
        <AudioComponent
          ...
          title={language === "it" ? "Le Nostro Preghiera" : "Our Prayer"}
        />
      </div>

      <div className="audio-wrapper">
        <AudioComponent audioFile={PrayerSongSoftVersion}
          title={language === "it" ? "Le Nostro Preghiera (Versione Soffice)(Ingl" : "Our Prayer (Soft Version)(English)"}
        />
      </div>
