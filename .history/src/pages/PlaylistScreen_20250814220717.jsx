...
import BgImg3 from "../assets/images/txt_bg2.jpg";
import BgImg4 from "../assets/images/txt_bg2.jpg";
import "../App.css";
      ...
      {allSongs.map((song) => (
        <div className="song-card" key={song.songId}>
          ...
          <div className="more-action-card">
            ...
            {Array.isArray(song.songLyrics) && song.songLyrics.length > 0 && isOnline && (
              <button
