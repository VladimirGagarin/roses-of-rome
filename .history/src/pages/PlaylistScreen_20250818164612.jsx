...
export default function PlaylistScreen() {
  ...
  const handleEmbedSong = (song) => {
    ...
    navigator.clipboard.writeText(iframeCode).catch((err) => {
      ...
      {showShareMenu && (
        ...
        >
          <div 
            ...
            style={{
              position: 'fixed',
              left: `${Math.min(shareMenuPosition.x, window.innerWidth - 200)}px`,
              top: `${shareMenuPosition.y}px`,
              transform: shareMenuPosition.y > window.innerHeight - 150 
                ? 'translateY(-100%)' 
                : 'none'
            }}
