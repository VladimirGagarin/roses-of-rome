...
export default function HomeScreen() {
  ...
  const audioComponentRefs = useRef({
    romeOne: useRef(null),
    romeTwo: useRef(null),
    hybrid: useRef(null),
    hybridTwo: useRef(null),
  });

  // Function to pause all other audio
  const pauseAllOtherAudio = () => {
    Object.values(audioComponentRefs.current).forEach((ref) => {
      if (ref.current?.isPlaying()) {
        ref.current.pause();
      }
    });
  };
  // Play surprise song and pause others
