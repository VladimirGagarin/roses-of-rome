 ...
 return (
  ...
  <div className="overlay-modal">
    <div className="overlay-content">
      <button className="close-btn" onClick={() => setSurprise(false)}>
        ✕
      </button>
      <h3>{language === "it" ? "Versione Speciale" : "Special Version"}</h3>
      <AudioComponent audioFile={SupriseSong} title="Rose di Roma (Surprise Version)" />
