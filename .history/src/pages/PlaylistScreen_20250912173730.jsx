    ...
    <>
      ...
      {selectedAlbum && (
        <div className="album-description">
          <p>{albumDescriptions[selectedAlbum]?.[language] || albumDescriptions[selectedAlbum]?.en || ""}</p>
          ...
          <button
            ...
            onClick={() => {
              ...
              alert(language === "it" ? `Link copiato negli appunti! ${selectedAlbum}` : `Link copied to clipboard! ${selectedAlbum}`);
            }}
            title={language === "it" ? "Condividi questo album" : "Share this album"}
            aria-label={language === "it" ? "Condividi questo album" : "Share this album"}
          >
