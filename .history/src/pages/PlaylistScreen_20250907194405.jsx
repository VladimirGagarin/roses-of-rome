...
export default function PlaylistScreen() {
 const allSongs = useMemo(() => RosesOfRomeSongs(), []);
  ...
  const albumDescriptions = {
    ...
    "Picolla casa della Gioa": {
      it: "Dalla raccolta 'Piccola casa della Gioia' (2024) - Canzoni ispirate alla spiritualità e alla comunità.",
      en: "From the album 'Piccola casa della Gioia' (2024) - Songs inspired by spirituality and community."
    }
  };
