...
export default function PlaylistScreen() {
 const allSongs = useMemo(() => RosesOfRomeSongs(), []);
  ...
  const albumDescriptions = {
    Rosa: {
      it: "Dalla raccolta 'Rosa' (2021) - Una selezione di brani che esplorano temi di amore, speranza e fede.",
      en: "From the album 'Rosa' (2021) - A selection of songs exploring themes of love, hope, and faith.",
    ...
    SWM: {
      ...
      it: "Dalla raccolta 'Sing With Magdalene' (2023) - Un invito a cantare insieme e a condividere la gioia della musica.",
      en: "From the album 'Sing With Magdalene' (2023) - An invitation to sing together and share the joy of music."
    },
  };
            ...
            >
              ...
              {currentSongForShare.songAlbum === "Merito" && (
                <button onClick={handleYoutubeLink}>
                  <FaYoutube />
                  {language === "it" ? "Copia link Youtube" : "Copy Youtube Link"}
                </button>
              )}
            </div>
          </div>
