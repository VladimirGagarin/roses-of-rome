...
export default function HomeScreen() {
  ...
  useEffect(() => {
    if (showSurprise && audioRef.current) {
      // Note: Browsers may block autoplay unless initiated by user gesture
      const playPromise = audioRef.current.play();

      // Handle potential autoplay rejection
  ...
  useEffect(() => {
    ...
    console.log("Found lyric:", current);
  ...
  return (
    <div className="home-container">
      ...
      {language === "en" && (
        <p className="audio-notice">
          🎧 Songs are in English. Subtitles or lyrics may help you follow
          along.
        </p>
      )}
