...
const songTitle = song.songName[language] || song.songName.en;
  ...
  const handleEmbedSong = (song) => {
   ...
   const iframeCode = `<iframe width="100%" height="300" src="${embedUrl}" loading="lazy" frameborder="0" allow="autoplay" style="border:none" sandbox="allow-same-origin allow-scripts allow-popups"></iframe></div>`;
    navigator.clipboard
