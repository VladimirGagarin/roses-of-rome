      ...
      {selectedAlbum && (
        <div className="album-description">
          ...
          <button
            ...
            title={language === "it" ? "Condividi link album" : "Share album link"}
            aria-label={language === "it" ? "Condividi link album" : "Share album link"}
          >
            {language === "it" ? "Condividi link album" : "Share album link"}
          </button>
        </div>
      )}
