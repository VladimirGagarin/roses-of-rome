...
const songTitle = song.songName[language] || song.songName.en;
  ...
  const handleEmbedSong = (song) => {
   ...
   const iframeCode = `<div style="width:100%;max-width:400px;overflow:hidden;border-radius:10px"><iframe width="100%" height="300" src="${embedUrl}" frameborder="0" allow="autoplay" style="border:none" sandbox="allow-same-origin allow-scripts allow-popups"></iframe></div>`;
    navigator.clipboard
